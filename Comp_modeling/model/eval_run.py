...
import os
path_to_class = r'C:\Users\de_hauk\Documents\GitHub\Apps_Tzakiris_2013\Comp_modeling\model\class'
...
data_processed = data_analyses.get_data(True)
...
res_LR = data_analyses.corr_LR(res_fit_sep)
